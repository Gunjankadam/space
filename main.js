...
// Define the Dropbox file URL
const hdrUrl = 'https://firebasestorage.googleapis.com/v0/b/alumini8-3fd16.appspot.com/o/local%2FHDR_multi_nebulae.hdr?alt=media&token=a345d012-8204-41e2-915c-f69419d98014';

// Function to download HDR file and load it
async function loadHDR() {
  try {
    // Fetch the HDR file from Dropbox (as a Blob)
    const response = await fetch(hdrUrl);
    if (!response.ok) throw new Error('Failed to fetch HDR file.');

    const blob = await response.blob();

    // Create a local URL for the Blob
    const hdrBlobUrl = URL.createObjectURL(blob);

    // Load the HDR file using RGBELoader
    const loader = new RGBELoader();
    loader.load(hdrBlobUrl, (texture) => {
      texture.mapping = THREE.EquirectangularReflectionMapping;

      scene.environment = texture;
      scene.background = texture;

      console.log('HDR environment map successfully loaded!');
    }, undefined, (error) => {
      console.error('Error loading HDR with RGBELoader:', error);
    });
  } catch (error) {
    console.error('Error downloading HDR:', error);
  }
}

// Call the function to load the HDR file
loadHDR();
...
const STexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633606/suntext_mdtyrv.png'); // Load the texture
...
const planetRotationSpeeds = [0.02, 0.03, 0.009, 0.01, 0.009, 0.0075, 0.006, 0.0045]; // Rotation speeds for each planet
 ...
 const EMtexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633611/mercury_n12cja.jpg');
 ...
 const EEtexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633608/venus_o5mqdg.jpg');
 ...
 const Etexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633607/earth_main_qyutan.jpg');
 const EGTexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633610/eath_night_rgdvhi.jpg');
 ...
 const ECloudsTexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633607/Earth-clouds_x09erg.png');
 ...
 const moonTexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633610/moonmap_znhk1t.jpg');
 const moonMaterial = new THREE.MeshBasicMaterial({ map: moonTexture});
 const moon = new THREE.Mesh(moonGeometry, moonMaterial);
 const moongGeometry = new THREE.SphereGeometry(0.29, 32, 32);
 const moongTexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633607/moong_puhsdm.png');
 ...
 //mars
   ...
   const Mtexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633610/mmap_bn4sus.jpg');
   ...
   const Mgtexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633611/redg_stpqgx.png');
  ...
  //jupiter
   ...
   const JTexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633606/Jupmap_umb4d6.jpg');
   ...
   const JCTexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633609/Jupcloud_nz9ptw.png');
   ...
   const SaTexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633611/saturnmapp_jcex0a.jpg');
   ...
   const Urtexture = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633605/uranmap_wlo4z0.jpg');
   ...
   const Netexture  = new THREE.TextureLoader().load('https://res.cloudinary.com/dsjt220g8/image/upload/v1736633610/neptune_hspghx.jpg');
